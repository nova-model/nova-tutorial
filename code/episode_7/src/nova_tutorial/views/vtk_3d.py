...
from nova.trame.view.layouts import HBoxLayout  # type: ignore
from trame.widgets import vtk as vtkw  # type: ignore
...
class VTKPlot:
    ...
    def __init__(self, view_model: VisualizationViewModel) -> None:
        ...
        self.view_model.config_vtk_bind.connect(self.render)

        self.create_vtk()
        self.create_ui()

    def create_vtk(self) -> None:
        self.renderer = vtkRenderer()  # type: ignore
        ...
        self.render_window_interactor.GetInteractorStyle().SetCurrentStyleToTrackballCamera()  # type: ignore
